...
>
> The conda environment for this project is contained in env.yml file. Please, run "conda activate env.yml" to set up the environment for this project.
...
* global_vars.py contains all global variables:
  1. Directories to ATom and pressure levels ECHAM data
  2. height_criteria as the top level to select the data. Near the surface marine aerosols have a greater influence
  3. name of model variable to compare to ATom 
  4. ATom variable to compare
